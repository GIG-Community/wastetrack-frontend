          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">Manage payments for collectors and customers</p>
              </div>
            </div>
          ...
          {selectedUserId && (
            <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3">
              ...
              {users.find(u => u.id === selectedUserId)?.role === 'customer' && (
                <div className="p-4 bg-white border shadow-sm rounded-xl border-zinc-200">
                  <h3 className="text-sm font-medium text-zinc-500">Available Points</h3>
                  <p className="text-2xl font-semibold text-zinc-800">{userStats.points.toLocaleString()}</p>
                </div>
              )}
              <div className="p-4 bg-white border shadow-sm rounded-xl border-zinc-200">
                    ...
                    {users.find(u => u.id === selectedUserId)?.role === 'customer' ? (
                      <div>
                        ...
                        <p className="mt-2 text-sm text-zinc-500">
                          Amount to receive: Rp {(pointsToConvert * 100).toLocaleString()}
                        </p>
