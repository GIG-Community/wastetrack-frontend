...
const StatCard = ({ icon: Icon, label, value, subValue, trend, trendValue, trendSuffix = '%' }) => (
  <div className="p-6 transition-all bg-white border shadow-sm rounded-xl border-zinc-200 hover:shadow-md group">
...
const InfoTooltip = ({ children }) => (
  <div className="relative inline-block group">
    ...
    <div className="absolute invisible w-48 px-3 py-2 mb-2 text-xs text-white transition-all -translate-x-1/2 rounded-lg opacity-0 bottom-full left-1/2 bg-zinc-800 group-hover:opacity-100 group-hover:visible">
      {children}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-4">
                  ...
                  <div className="p-4 rounded-lg bg-white/50">
                    ...
                    <p className="mt-1 text-xs text-emerald-700">equivalent saved</p>
                  </div>
